...
*/
    ...
    {RIL_UNSOL_ENTER_LPM_M7, responseVoid, WAKE_PARTIAL},                                   // s_unsolResponses[43]: 3023
    {RIL_UNSOL_CDMA_3G_INDICATOR, responseInts, WAKE_PARTIAL},                              // s_unsolResponses[44]: 3009
    {RIL_UNSOL_CDMA_3G_INDICATOR_M7, responseInts, WAKE_PARTIAL},                           // s_unsolResponses[44]: 4259
    {RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR, responseInts, WAKE_PARTIAL},                 // s_unsolResponses[45]: 3012
    {RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR_M7, responseInts, WAKE_PARTIAL},              // s_unsolResponses[45]: 4626
    {RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL, responseStrings, WAKE_PARTIAL},             // s_unsolResponses[46]: 3020
    {RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL_M7, responseStrings, WAKE_PARTIAL},          // s_unsolResponses[46]: 4270
    {RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE, responseInts, WAKE_PARTIAL},                     // s_unsolResponses[47]: 6002
    {RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE_M7, responseInts, WAKE_PARTIAL},                  // s_unsolResponses[47]: 4802
    ...
    {RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_HTC_M7, responseVoid, WAKE_PARTIAL},      // s_unsolResponses[49]: 5755
    {RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED, responseInts, WAKE_PARTIAL},            // s_unsolResponses[50]: 21007
    {RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_M7, responseInts, WAKE_PARTIAL},         // s_unsolResponses[51]: 5757
